...
def register(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            send_email.send()
            # messages.success(request, 'Thank you for registering with us. We have sent you a verification email to your email address [rajputanuragsingh77@gmail.com]. Please verify it.')
            ...
            try:
                ...
                if is_cart_item_exists:
                    ...
                    for pr in product_variation:
                        if pr in ext_var_list:
                            index = ext_var_list.index(pr)
                            item_id = id[index]
...
def resetPassword(request):
    if request.method == "POST":
        ...
        if password == confirm_password:
            ...
            user.set_password(password)   # save password in hash formate
            user.save()
